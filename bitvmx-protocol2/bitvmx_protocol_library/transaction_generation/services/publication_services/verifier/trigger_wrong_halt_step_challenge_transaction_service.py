...
class TriggerWrongHaltStepChallengeTransactionService:
    ...
    def __call__(
        ...
        trigger_wrong_halt_step_control_block_hex = bitvmx_protocol_setup_properties_dto.bitvmx_bitcoin_scripts_dto.trigger_trace_challenge_scripts_list.get_control_block_hex(
            public_key=bitvmx_protocol_setup_properties_dto.unspendable_public_key,
        ...
        bitvmx_protocol_setup_properties_dto.bitvmx_transactions_dto.trigger_equivocation_tx.witnesses.append(
            TxWitnessInput(
                ...
                + [
                    ...
                    trigger_wrong_halt_step_control_block_hex,
                ]
            )
        )
