...
from prover_app.api.v1.setup.crud.view_models.post import SetupPostV1Input, SetupPostV1Output
...
class SetupPostViewControllerV1:
    ...
    async def __call__(self, setup_post_view_input: SetupPostV1Input) -> SetupPostV1Output:
        ...
        funding_amount = setup_post_view_input.funding_amount_of_satoshis
        ...
        setup_uuid = await self.create_setup_controller(
            ...
            funding_amount_of_satoshis=funding_amount,  # 추가: 사용할 금액 전달
        )
